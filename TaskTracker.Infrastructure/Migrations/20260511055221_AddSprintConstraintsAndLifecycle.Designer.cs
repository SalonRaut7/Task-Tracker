...
namespace TaskTracker.Infrastructure.Migrations
{
    ...
    [Migration("20260511055221_AddSprintConstraintsAndLifecycle")]
    partial class AddSprintConstraintsAndLifecycle
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskTracker.Domain.Entities.Sprint", b =>
                {
                    ...
                    b.ToTable("Sprints", t =>
                        {
                            t.HasCheckConstraint("CK_Sprints_CreatedAt_UpdatedAt", "\"CreatedAt\" <= \"UpdatedAt\"");

                            t.HasCheckConstraint("CK_Sprints_StartDate_EndDate", "\"StartDate\" <= \"EndDate\"");

                            t.HasCheckConstraint("CK_Sprints_ValidStatus", "\"Status\" IN (0, 1, 2, 3, 4)");
                        });
                });
            ...
            modelBuilder.Entity("TaskTracker.Domain.Entities.TaskAttachment", b =>
                {
                    ...
                    b.HasOne("TaskTracker.Domain.Entities.Identity.ApplicationUser", "Uploader")
                        .WithMany()
