...
{
    /// <inheritdoc />
    public partial class AddIdentityAndAuthEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssueNumber = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Title = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.AddCheckConstraint(
                name: "CK_Tasks_CreatedAt_UpdatedAt",
                table: "Tasks",
                sql: "\"CreatedAt\" <= \"UpdatedAt\"");

            migrationBuilder.AddCheckConstraint(
                name: "CK_Tasks_StartDate_EndDate",
                table: "Tasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpEntries_UserId_Purpose",
                table: "OtpEntries",
